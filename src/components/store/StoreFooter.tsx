      ...
      <div className="container-store py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-cairo font-black text-lg leading-tight">كوكي هوم</p>
                <p className="font-cairo text-gold text-sm leading-tight">COKIE HOME</p>
              </div>
            </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-cairo text-xs text-white/30">
            © {new Date().getFullYear()} كوكي هوم — جميع الحقوق محفوظة
          </p>
